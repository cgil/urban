...
const styleSheet = createStyleSheet('HomeDetail', (theme) => ({
...
function HomeDetail(props, context) {
  const classes = context.styleManager.render(styleSheet);
  return (
    <Paper elevation={0} square className={classes.backgroundImage} style={{ backgroundImage: `url(${props.image})` }}>
      <Layout
        container
